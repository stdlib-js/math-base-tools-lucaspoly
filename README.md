...
-   [`@stdlib/math/base/tools/fibpoly`][@stdlib/math/base/tools/fibpoly]: evaluate a Fibonacci polynomial.
...
[test-image]: https://github.com/stdlib-js/math-base-tools-lucaspoly/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/math-base-tools-lucaspoly/actions/workflows/test.yml
